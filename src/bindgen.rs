...
extern "C" {
    ...
    pub fn blosc_compress_ctx(
        ...
        dest: *mut ::core::ffi::c_void,
        destsize: usize,
        compressor: *const ::core::ffi::c_char,
        blocksize: usize,
        numinternalthreads: ::core::ffi::c_int,
    ) -> ::core::ffi::c_int;
}
extern "C" {
...
extern "C" {
    ...
    pub fn blosc_get_nthreads() -> ::core::ffi::c_int;
}
extern "C" {
    ...
    pub fn blosc_set_nthreads(nthreads: ::core::ffi::c_int) -> ::core::ffi::c_int;
}
extern "C" {
    #[doc = "Returns the current compressor that is being used for compression."]
    pub fn blosc_get_compressor() -> *const ::core::ffi::c_char;
}
extern "C" {
    ...
    pub fn blosc_set_compressor(compname: *const ::core::ffi::c_char) -> ::core::ffi::c_int;
}
extern "C" {
    ...
    pub fn blosc_compcode_to_compname(
        compcode: ::core::ffi::c_int,
        compname: *mut *const ::core::ffi::c_char,
    ) -> ::core::ffi::c_int;
}
extern "C" {
    ...
    pub fn blosc_compname_to_compcode(
        compname: *const ::core::ffi::c_char,
    ) -> ::core::ffi::c_int;
}
extern "C" {
    ...
    pub fn blosc_list_compressors() -> *const ::core::ffi::c_char;
}
extern "C" {
    #[doc = "Return the version of the C-Blosc library in string format.\n\nUseful for dynamic libraries."]
    pub fn blosc_get_version_string() -> *const ::core::ffi::c_char;
}
extern "C" {
    ...
    pub fn blosc_get_complib_info(
        compname: *const ::core::ffi::c_char,
        complib: *mut *mut ::core::ffi::c_char,
        version: *mut *mut ::core::ffi::c_char,
    ) -> ::core::ffi::c_int;
}
extern "C" {
    ...
    pub fn blosc_free_resources() -> ::core::ffi::c_int;
}
extern "C" {
...
extern "C" {
    ...
    pub fn blosc_cbuffer_versions(
        ...
        compversion: *mut ::core::ffi::c_int,
    );
}
extern "C" {
...
extern "C" {
    ...
    pub fn blosc_get_blocksize() -> ::core::ffi::c_int;
}
extern "C" {
...
extern "C" {
    ...
    pub fn blosc_set_splitmode(splitmode: ::core::ffi::c_int);
}
